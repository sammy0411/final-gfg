          ...
          {name.map((curr_val, curr_idx) => {
            ...
            return (
              <li style={{listStyleType:"Bullet"}}>
                <span style={{color:"#f0bb62"}}>{curr_val}</span> the latitude is {lat1[curr_idx]} and longitude{" "}
                {lon1[curr_idx]} Address is <span style={{color:"green"}}>{address[curr_idx]}</span>
              </li>
            );
          })}
        </ul>
