  ...
  const fetchLocation = async () => {
    ...
    if (!email) {
      ...
      try {
        ...
        try {
          let s1 = `https://api.tomtom.com/search/2/geocode/${d_now.data.address}.json?key=UiYgyrE8umErv77zmFuNaEDQRWejRbiz`;
          console.log(s1);
    ...
    if (true) {
      ...
      setLat1(lat - b * Math.cos(45));
      lat11 = lat - b * Math.cos(45);
      lon11 = lon - b * Math.sin(45);

      setLon1(lon - b * Math.sin(45));
      // console.log(lon, lat);

      setLat2(lat + b * Math.cos(45));
      lat12 = lat + b * Math.cos(45);
      setLon2(lon - b * Math.sin(45));
      lon12 = lon - b * Math.sin(45);

      setLat3(lat + b * Math.cos(45));
      lat13 = lat + b * Math.cos(45);
      setLon3(lon + b * Math.sin(45));
      lon13 = lon + b * Math.sin(45);

      setLat4(lat - b * Math.cos(45));
      lat14 = lat - b * Math.cos(45);
      setLon4(lon + b * Math.sin(45));
      lon14 = lon + b * Math.sin(45);
      setDone(1);
      console.log(done);
    }
    // second api call
